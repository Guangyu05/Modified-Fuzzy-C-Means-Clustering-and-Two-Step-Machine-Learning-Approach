...
function [y_train,y_test,y_train_raw,y_test_raw,y_train_raw_target,...
    ...
    y_test_split_target] = EMGdataprocess_group_2_2(y,n)
...
y_train_raw_target = zeros(3,size(Train_label,2)/2);
...
y_test_raw_target = zeros(3,size(Test_label,2)/2);
...
y_train_split_target = zeros(3,numel(y_train_split));
...
y_test_split_target = zeros(3,numel(y_test_split));
