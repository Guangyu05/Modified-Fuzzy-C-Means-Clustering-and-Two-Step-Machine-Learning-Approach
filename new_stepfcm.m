function [U_new, center, obj_fcn] = stepfcm(data, U, cluster_n, expo, class_n)
...
data_1 = zeros(class_n,size(data,2));
center = mf*data_1./(sum(mf,2)*ones(1,size(data,2))); %new center
