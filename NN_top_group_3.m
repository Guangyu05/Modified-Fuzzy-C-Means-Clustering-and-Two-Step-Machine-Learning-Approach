...
Train_output_3_new = zeros(2,size(Train_Output,2));
for i = 1:size(Train_Output,2)
    Train_output_3_new(target_train(i),i) = 1;
end

Test_output_3_new = zeros(2,size(Test_Output,2));
for i = 1:size(Test_Output,2)
    Test_output_3_new(target_test(i),i) = 1;
end



x = Train_Input;
t = Train_output_3_new;
% rng('default')
...
%     switch indices
%         case 1
%         temp_label = double(mode(classify(cnn_group_1,temp_data)));
%         switch temp_label
%             case 1
...
%         end
%         case 2
%         temp_label = double(mode(classify(cnn_group_2,temp_data)));
%         switch temp_label
%             case 1
...
%         end    
%         case 3
%         temp_label = double(mode(classify(cnn_group_3,temp_data)));
%         switch temp_label
%             case 1
